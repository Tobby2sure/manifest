...
const SEED_INTENTS = [
  // Partnership (5)
  { type: "partnership", ecosystem: "base", sector: "defi", priority: "Active",
  ...
  { type: "partnership", ecosystem: "base", sector: "infrastructure", priority: "Open",
  ...
  { type: "partnership", ecosystem: "ethereum", sector: "social", priority: "Active",
  ...
  { type: "partnership", ecosystem: "multi-chain", sector: "gaming", priority: "Open",
  ...
  { type: "partnership", ecosystem: "base", sector: "payments", priority: "Urgent",
  ...
  // Integration (5)
  { type: "integration", ecosystem: "base", sector: "defi", priority: "Active",
  ...
  { type: "integration", ecosystem: "base", sector: "infrastructure", priority: "Open",
  ...
  { type: "integration", ecosystem: "arbitrum", sector: "defi", priority: "Active",
  ...
  { type: "integration", ecosystem: "base", sector: "security", priority: "Open",
  ...
  { type: "integration", ecosystem: "solana", sector: "nft", priority: "Active",
  ...
  // Co-marketing (4)
  { type: "co-marketing", ecosystem: "base", sector: "defi", priority: "Open",
  ...
  { type: "co-marketing", ecosystem: "base", sector: "social", priority: "Active",
  ...
  { type: "co-marketing", ecosystem: "multi-chain", sector: "gaming", priority: "Open",
  ...
  { type: "co-marketing", ecosystem: "base", sector: "infrastructure", priority: "Open",
  ...
  // Investment (4)
  { type: "investment", ecosystem: "base", sector: "defi", priority: "Active",
  ...
  { type: "investment", ecosystem: "base", sector: "ai", priority: "Urgent",
  ...
  { type: "investment", ecosystem: "ethereum", sector: "identity", priority: "Active",
  ...
  { type: "investment", ecosystem: "multi-chain", sector: "infrastructure", priority: "Open",
  ...
  // Hiring (3)
  { type: "hiring", ecosystem: "base", sector: "defi", priority: "Urgent",
  ...
  { type: "hiring", ecosystem: "base", sector: "social", priority: "Active",
  ...
  { type: "hiring", ecosystem: "multi-chain", sector: "infrastructure", priority: "Open",
  ...
  // Grant (2)
  { type: "grant", ecosystem: "base", sector: "infrastructure", priority: "Active",
  ...
  { type: "grant", ecosystem: "base", sector: "defi", priority: "Open",
  ...
  // Ecosystem Support (2)
  { type: "ecosystem-support", ecosystem: "base", sector: "infrastructure", priority: "Active",
  ...
  { type: "ecosystem-support", ecosystem: "base", sector: "defi", priority: "Open",
  ...
  // Beta Testers (2)
  { type: "beta-testers", ecosystem: "base", sector: "social", priority: "Active",
  ...
  { type: "beta-testers", ecosystem: "base", sector: "defi", priority: "Open",
